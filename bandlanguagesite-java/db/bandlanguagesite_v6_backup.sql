...
INSERT INTO `bls_dept_node` VALUES (14, 3, 14, 1);
INSERT INTO `bls_dept_node` VALUES (15, 3, 15, 1);
INSERT INTO `bls_dept_node` VALUES (16, 2, 16, 1);
...
INSERT INTO `bls_dept_node` VALUES (22, 3, 22, 0);
INSERT INTO `bls_dept_node` VALUES (23, 3, 23, 0);
INSERT INTO `bls_dept_node` VALUES (24, 3, 24, 0);
COMMIT;
...
INSERT INTO `bls_dept_rule` VALUES (16, 3, 16, 1);
INSERT INTO `bls_dept_rule` VALUES (17, 3, 17, 1);
INSERT INTO `bls_dept_rule` VALUES (18, 3, 18, 1);
INSERT INTO `bls_dept_rule` VALUES (19, 2, 19, 1);
...
INSERT INTO `bls_dept_rule` VALUES (25, 3, 25, 0);
INSERT INTO `bls_dept_rule` VALUES (26, 3, 26, 0);
COMMIT;
...
INSERT INTO `bls_dept_sentence` VALUES (57, 3, 57, 0);
INSERT INTO `bls_dept_sentence` VALUES (58, 3, 58, 1);
COMMIT;
...
INSERT INTO `bls_dept_word` VALUES (82, 1, 87, 1);
INSERT INTO `bls_dept_word` VALUES (83, 1, 88, 1);
INSERT INTO `bls_dept_word` VALUES (84, 1, 89, 1);
INSERT INTO `bls_dept_word` VALUES (85, 1, 90, 1);
INSERT INTO `bls_dept_word` VALUES (86, 1, 91, 1);
INSERT INTO `bls_dept_word` VALUES (87, 3, 92, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bls_node` VALUES (1, 'node1', 'package1', 'node1 code', 2, 1, '2021-06-16 15:03:28', 1);
...
INSERT INTO `bls_node` VALUES (4, 'Organization', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class Organization extends Noun{\n    public String text;\n\n    public Organization(String text) {\n        this.text = text;\n    }\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:05:40', 1);
INSERT INTO `bls_node` VALUES (5, 'Department', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class Department extends Noun {\n\n    public String text;\n\n    public Department(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:13:13', 1);
INSERT INTO `bls_node` VALUES (6, 'ParentDepartment', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class ParentDepartment extends Noun{\n\n    public String text;\n\n    public ParentDepartment(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:14:42', 1);
INSERT INTO `bls_node` VALUES (7, 'SuperiorDepartment', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class SuperiorDepartment extends Noun{\n\n    public String text;\n\n    public SuperiorDepartment(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:15:42', 1);
INSERT INTO `bls_node` VALUES (8, 'SubDepartment', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\n\npublic class SubDepartment extends Noun {\n\n    public String text;\n\n    public SubDepartment(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:27:22', 1);
INSERT INTO `bls_node` VALUES (9, 'Band', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class Band extends Noun {\n    public String text;\n\n    public Band(String text) {\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:29:25', 1);
INSERT INTO `bls_node` VALUES (10, 'ParentBand', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class ParentBand extends Noun{\n\n    public String text;\n\n    public ParentBand(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:30:24', 1);
INSERT INTO `bls_node` VALUES (11, 'Position', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\n\npublic class Position extends Noun {\n\n    public String text;\n\n    public Position(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:31:58', 1);
INSERT INTO `bls_node` VALUES (12, 'Member', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class Member extends Noun {\n    public String text;\n\n    public Member(String text) {\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:33:21', 1);
INSERT INTO `bls_node` VALUES (13, 'Tool', 'com.language.node.word.noun', 'package com.language.node.word.noun;\n\npublic class Tool extends Noun {\n    public String text;\n\n    public Tool(String text) {\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 1, 1, '2021-06-07 10:35:15', 1);
INSERT INTO `bls_node` VALUES (14, 'node4', 'package4', 'node4 code', 2, 2, '2021-06-08 20:10:45', 1);
INSERT INTO `bls_node` VALUES (15, 'node5', 'package5', 'node5 code', 2, 2, '2021-06-08 21:16:07', 1);
INSERT INTO `bls_node` VALUES (16, '1', '1', '2', 1, 1, '2021-06-11 11:17:48', 1);
INSERT INTO `bls_node` VALUES (17, 'Role', 'com.language.node.word.noun', 'public class Role extends Noun {\n\n    public String text;\n\n    public Role(String text) {\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 4, 4, '2021-06-11 16:50:29', 1);
INSERT INTO `bls_node` VALUES (18, 'Authority', 'com.language.node.word.noun', 'public class Authority extends Noun{\n\n    public String text;\n\n    public Authority(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        return super.run(methodName);\n    }\n}', 4, 4, '2021-06-11 16:54:24', 1);
INSERT INTO `bls_node` VALUES (19, 'Reader', 'com.language.node.word.noun', 'import com.language.environment.Environment;\n\npublic class Reader extends Noun {\n    public String text;\n\n    public Reader(String text) {\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        Integer type = 1;//读者类型\n        Environment.environment.put(\"Noun\", type);\n        return true;\n    }\n}', 4, 4, '2021-06-11 16:59:05', 1);
INSERT INTO `bls_node` VALUES (20, 'Writer', 'com.language.node.word.noun', 'import com.language.environment.Environment;\n\npublic class Writer extends Noun {\n    public String text;\n\n    public Writer(String text) {\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        Integer type = 2;//写者类型\n        Environment.environment.put(\"Noun\", type);\n        return true;\n    }\n}', 4, 4, '2021-06-11 17:06:30', 1);
INSERT INTO `bls_node` VALUES (21, 'Speaker', 'com.language.node.word.noun', 'import com.language.environment.Environment;\n\npublic class Speaker extends Noun{\n\n    public String text;\n\n    public Speaker(String text){\n        this.text = text;\n    }\n\n    @Override\n    public boolean run(String methodName) {\n        Integer type = 0;//言者类型\n        Environment.environment.put(\"Noun\", type);\n        return true;\n    }\n}', 4, 4, '2021-06-11 17:09:28', 1);
INSERT INTO `bls_node` VALUES (22, 'node6', 'package6', 'node6 code', 2, 2, '2021-06-16 16:48:37', 0);
INSERT INTO `bls_node` VALUES (23, 'node7', 'package7', 'node7 code', 2, 2, '2021-06-16 16:49:41', 0);
INSERT INTO `bls_node` VALUES (24, 'node6', 'package6', 'node6 code', 4, 4, '2021-06-16 17:24:16', 0);
COMMIT;
...
INSERT INTO `bls_node_user` VALUES (4, 4, 1, '2021-06-07 10:05:40', 1);
INSERT INTO `bls_node_user` VALUES (5, 5, 1, '2021-06-07 10:13:13', 1);
INSERT INTO `bls_node_user` VALUES (6, 6, 1, '2021-06-07 10:14:42', 1);
INSERT INTO `bls_node_user` VALUES (7, 7, 1, '2021-06-07 10:15:42', 1);
INSERT INTO `bls_node_user` VALUES (8, 8, 1, '2021-06-07 10:27:22', 1);
INSERT INTO `bls_node_user` VALUES (9, 9, 1, '2021-06-07 10:29:25', 1);
INSERT INTO `bls_node_user` VALUES (10, 10, 1, '2021-06-07 10:30:24', 1);
INSERT INTO `bls_node_user` VALUES (11, 11, 1, '2021-06-07 10:31:58', 1);
INSERT INTO `bls_node_user` VALUES (12, 12, 1, '2021-06-07 10:33:21', 1);
INSERT INTO `bls_node_user` VALUES (13, 13, 1, '2021-06-07 10:35:15', 1);
INSERT INTO `bls_node_user` VALUES (14, 14, 2, '2021-06-08 20:10:45', 1);
INSERT INTO `bls_node_user` VALUES (15, 15, 2, '2021-06-08 21:16:07', 1);
INSERT INTO `bls_node_user` VALUES (16, 16, 1, '2021-06-11 11:17:48', 1);
INSERT INTO `bls_node_user` VALUES (17, 17, 4, '2021-06-11 16:50:29', 1);
INSERT INTO `bls_node_user` VALUES (18, 18, 4, '2021-06-11 16:54:24', 1);
INSERT INTO `bls_node_user` VALUES (19, 19, 4, '2021-06-11 16:59:05', 1);
INSERT INTO `bls_node_user` VALUES (20, 20, 4, '2021-06-11 17:06:30', 1);
INSERT INTO `bls_node_user` VALUES (21, 21, 4, '2021-06-11 17:09:28', 1);
INSERT INTO `bls_node_user` VALUES (22, 1, 1, '2021-06-16 15:03:28', 1);
INSERT INTO `bls_node_user` VALUES (23, 22, 2, '2021-06-16 16:48:27', 0);
INSERT INTO `bls_node_user` VALUES (24, 23, 2, '2021-06-16 16:49:14', 0);
INSERT INTO `bls_node_user` VALUES (25, 24, 4, '2021-06-16 17:23:58', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bls_paradigm` VALUES (1, 1, '创建 字符串 部门', '创建 “测试123” 部门', 123, 123, '2021-06-16 18:21:22', 1);
INSERT INTO `bls_paradigm` VALUES (2, 1, '新建 字符串 部门', '新建 “的地方” 部门', 123, 123, '2021-06-16 18:21:28', 1);
INSERT INTO `bls_paradigm` VALUES (3, 1, '中间范式1', 'bbb', 2, 2, '2021-06-17 11:26:56', 0);
INSERT INTO `bls_paradigm` VALUES (4, 58, 'aaa', 'aaa', 2, 2, '2021-06-17 15:41:53', 0);
INSERT INTO `bls_paradigm` VALUES (5, 58, 'bbb', 'bbbb', 2, 2, '2021-06-17 15:41:20', 1);
COMMIT;
...
INSERT INTO `bls_rule` VALUES (4, 'Organization', '机构', '\'机构\'', '词汇规则', 'return null;', 1, 1, '2021-06-07 10:04:42', 1);
INSERT INTO `bls_rule` VALUES (5, 'Department', '部门', '\'部门\'', '词汇规则-部门', 'return null', 1, 1, '2021-06-07 10:09:41', 1);
INSERT INTO `bls_rule` VALUES (6, 'ParentDepartment', '父部门', '\'父部门\'', '词汇规则-父部门', 'return null;', 1, 1, '2021-06-07 10:14:21', 1);
INSERT INTO `bls_rule` VALUES (7, 'SuperiorDepartment', '上级部门', '\'上级部门\'', '词汇规则-上级部门', 'return null;', 1, 1, '2021-06-07 10:15:25', 1);
INSERT INTO `bls_rule` VALUES (8, 'SubDepartment', '子部门', '\'子部门\' | \'下级部门\'', '词汇规则-子部门', 'return null;', 1, 1, '2021-06-07 10:23:21', 1);
INSERT INTO `bls_rule` VALUES (9, 'Band', '帮区', '\'帮区\'', '词汇规则-帮区', 'return null;', 1, 1, '2021-06-07 10:29:01', 1);
INSERT INTO `bls_rule` VALUES (10, 'ParentBand', '父帮区', '\'父帮区\'', '词汇规则-父帮区', 'return null;', 1, 1, '2021-06-07 10:30:06', 1);
INSERT INTO `bls_rule` VALUES (11, 'SubBand', '子帮区', '\'子帮区\'', '词汇规则-子帮区', 'return null;', 1, 1, '2021-06-07 10:31:03', 1);
INSERT INTO `bls_rule` VALUES (12, 'Position', '岗位', '\'岗位\'', '词汇规则-岗位', 'return null;', 1, 1, '2021-06-07 10:31:30', 1);
INSERT INTO `bls_rule` VALUES (13, 'Member', '成员', '\'成员\'', '词汇规则-成员', 'return null;', 1, 1, '2021-06-07 10:33:03', 1);
INSERT INTO `bls_rule` VALUES (14, 'Tool', '工具', '\'工具\'', '词汇规则-工具', 'wordMap.put(\"工具\", new Tool());', 1, 4, '2021-06-11 16:46:23', 1);
INSERT INTO `bls_rule` VALUES (16, 'rule4', '规则4', '规则4的表达式', '规则4的描述', 'rule4 code', 2, 2, '2021-06-08 17:49:33', 1);
INSERT INTO `bls_rule` VALUES (17, 'rule5', '规则5', '规则5的表达式', '规则5的描述', 'rule5 code', 2, 2, '2021-06-08 20:01:43', 1);
INSERT INTO `bls_rule` VALUES (18, 'rule6', '规则6', '规则6的表达式', '规则6的描述', 'rule6 code', 2, 2, '2021-06-08 21:15:31', 1);
INSERT INTO `bls_rule` VALUES (19, '1', '1', '1', '1', '1', 1, 1, '2021-06-11 11:18:58', 1);
INSERT INTO `bls_rule` VALUES (20, 'Role', '角色', '\'角色\'', '角色规则', 'wordMap.put(\"角色\", new Role());', 4, 4, '2021-06-11 16:49:36', 1);
INSERT INTO `bls_rule` VALUES (21, 'Authority', '权限', '\'权限\'', '权限规则', 'wordMap.put(\"权限\", new Authority());', 4, 4, '2021-06-11 16:52:56', 1);
INSERT INTO `bls_rule` VALUES (22, 'Reader', '读者', '\'读者\'', '读者规则', 'wordMap.put(\"i读者\", new Reader());', 4, 4, '2021-06-11 16:58:41', 1);
INSERT INTO `bls_rule` VALUES (23, 'Writer', '写者', '\'写者\'', '写者规则', 'wordMap.put(\"写者\", new Writer());', 4, 4, '2021-06-11 17:06:01', 1);
INSERT INTO `bls_rule` VALUES (24, 'Speaker', '言者', '\'言者\'', '言者规则', 'wordMap.put(\"言者\", new Speaker());', 4, 4, '2021-06-11 17:09:08', 1);
INSERT INTO `bls_rule` VALUES (25, 'rule7', '规则7', '规则7的表达式', '规则7的描述', 'rule7 code', 2, 4, '2021-06-16 17:00:55', 0);
INSERT INTO `bls_rule` VALUES (26, 'rule7', '规则7', '规则7的表达式', '规则7的描述', 'rule7 code', 4, 4, '2021-06-16 17:20:11', 0);
COMMIT;
...
INSERT INTO `bls_rule_user` VALUES (4, 4, 1, '2021-06-07 10:04:42', 1);
INSERT INTO `bls_rule_user` VALUES (5, 5, 1, '2021-06-07 10:09:41', 1);
INSERT INTO `bls_rule_user` VALUES (6, 6, 1, '2021-06-07 10:14:21', 1);
INSERT INTO `bls_rule_user` VALUES (7, 7, 1, '2021-06-07 10:15:25', 1);
INSERT INTO `bls_rule_user` VALUES (8, 8, 1, '2021-06-07 10:23:21', 1);
INSERT INTO `bls_rule_user` VALUES (9, 9, 1, '2021-06-07 10:29:01', 1);
INSERT INTO `bls_rule_user` VALUES (10, 10, 1, '2021-06-07 10:30:06', 1);
INSERT INTO `bls_rule_user` VALUES (11, 11, 1, '2021-06-07 10:31:03', 1);
INSERT INTO `bls_rule_user` VALUES (12, 12, 1, '2021-06-07 10:31:30', 1);
INSERT INTO `bls_rule_user` VALUES (13, 13, 1, '2021-06-07 10:33:03', 1);
INSERT INTO `bls_rule_user` VALUES (14, 14, 1, '2021-06-07 10:34:45', 1);
INSERT INTO `bls_rule_user` VALUES (16, 16, 2, '2021-06-08 17:49:33', 1);
INSERT INTO `bls_rule_user` VALUES (17, 17, 2, '2021-06-08 20:01:43', 1);
INSERT INTO `bls_rule_user` VALUES (18, 18, 2, '2021-06-08 21:15:31', 1);
INSERT INTO `bls_rule_user` VALUES (19, 19, 1, '2021-06-11 11:18:58', 1);
INSERT INTO `bls_rule_user` VALUES (20, 14, 4, '2021-06-11 16:46:23', 1);
INSERT INTO `bls_rule_user` VALUES (21, 20, 4, '2021-06-11 16:49:36', 1);
INSERT INTO `bls_rule_user` VALUES (22, 21, 4, '2021-06-11 16:52:56', 1);
INSERT INTO `bls_rule_user` VALUES (23, 22, 4, '2021-06-11 16:58:41', 1);
INSERT INTO `bls_rule_user` VALUES (24, 23, 4, '2021-06-11 17:06:01', 1);
INSERT INTO `bls_rule_user` VALUES (25, 24, 4, '2021-06-11 17:09:08', 1);
INSERT INTO `bls_rule_user` VALUES (26, 25, 2, '2021-06-16 16:55:29', 0);
INSERT INTO `bls_rule_user` VALUES (27, 26, 4, '2021-06-16 17:04:57', 0);
COMMIT;
...
INSERT INTO `bls_sentence` VALUES (57, '测试句型', '测试句型的描述', '测试句型的巴克斯范式表示', 2, 2, '2021-06-17 15:42:25', 0, 0);
INSERT INTO `bls_sentence` VALUES (58, '测试句型', '测试句型的描述', '测试句型的巴克斯范式表示', 2, 2, '2021-06-17 15:41:53', 0, 1);
COMMIT;
...
CREATE TABLE `bls_sentence_user` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '状态：0：禁用，1：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用于记录参与创建或修改句型的用户';
...
INSERT INTO `bls_sentence_user` VALUES (57, 57, 2, '2021-06-17 14:44:23', 0);
INSERT INTO `bls_sentence_user` VALUES (58, 58, 2, '2021-06-17 15:41:20', 1);
COMMIT;
...
INSERT INTO `bls_user` VALUES (2, 'liwei', '黎威', '6b63d04f80af99ae5cde482a3559c459', '(UjrELVjqwof', '13387603239', '1011529903@qq.com', NULL, '2021-05-22 15:21:45', '2021-05-22 15:21:47', 21, 1);
...
INSERT INTO `bls_user` VALUES (4, 'xujiankang', '徐健康', 'a52d8d5577a09a209759f1950a3a9fad', 'c@8JSeY4969D', NULL, NULL, NULL, '2021-05-24 11:27:34', '2021-05-24 11:27:37', 4, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='帮语词汇表';
...
INSERT INTO `bls_word` VALUES (8, '推荐', '向别人推荐论文', '论文推荐', 2, '建议', 2, 2, '2021-06-07 19:28:01', 1, 1);
...
INSERT INTO `bls_word` VALUES (12, '机构', '表示支撑平台中的机构实体，与支撑平台相关', '创建机构', 1, '', 4, 4, '2021-05-24 11:37:43', 1, 1);
INSERT INTO `bls_word` VALUES (13, '部门', '表示支撑平台中的部门实体，范围上属于机构的子集，是机构的下一级单位。', '创建部门', 1, '', 4, 4, '2021-05-24 11:38:48', 1, 1);
INSERT INTO `bls_word` VALUES (14, '父部门', '是指某个部门的直接上级部门，只有一个，需要以某个部门为基才能定位其父部门。', '某某部门的父部门是什么', 1, '', 4, 4, '2021-05-24 11:41:31', 1, 1);
INSERT INTO `bls_word` VALUES (15, '上级部门', '指某个部门的所有上级部门，即遍历获得父部门的父部门，返回的部门数量可能不止一个。', '某某部门的上级部门是什么', 1, '', 4, 4, '2021-05-24 11:42:14', 1, 1);
INSERT INTO `bls_word` VALUES (16, '子部门', '是指某个部门的下级部门，可能不止一个，所以可能返回空或一个部门或部门集合。', '某某部门的子部门有多少个', 1, '', 4, 4, '2021-05-24 11:43:17', 1, 1);
INSERT INTO `bls_word` VALUES (17, '下级部门', '词法规则名和语义同“子部门”。', '某某部门的下级部门有多少个', 1, '', 4, 4, '2021-05-24 11:43:59', 0, 1);
INSERT INTO `bls_word` VALUES (18, '帮区', '表示支撑平台中的“帮区”实体，属于部门的一个子属性，对部门的各属性管理实质上是在部门的主帮区中进行。', '创建帮区', 1, '', 4, 4, '2021-05-24 11:46:51', 1, 1);
INSERT INTO `bls_word` VALUES (19, '父帮区', '指某个帮区的直接上一级帮区，仅指代直接父帮区，所以返回结果是零或一个帮区，需要以某个帮区为基才能定位其父帮区。', '某某帮区的父帮区是什么', 1, '', 4, 4, '2021-05-24 11:47:30', 1, 1);
INSERT INTO `bls_word` VALUES (20, '子帮区', '是指某个帮区的下级帮区，可能不止一个，所以可能返回空或一个帮区或帮区集合。', '创建子帮区', 1, '', 4, 4, '2021-05-24 11:48:15', 1, 1);
INSERT INTO `bls_word` VALUES (21, '岗位', '岗位实际上是多个成员组成的一个集合，形成了“岗位”实体，岗位存在于机构、部门和帮区中，对岗位的管理实际上就是对属性归成同一类的成员们的管理。', '创建岗位', 1, '', 4, 4, '2021-05-24 11:51:15', 1, 1);
INSERT INTO `bls_word` VALUES (22, '成员', '成员是机构、部门和帮区里的人员，对于成员的管理通常有添加、移除等操作。具体的管理操作也是需要在语句中和谓语动词结合才能确定。', '添加成员', 1, '', 4, 4, '2021-05-24 11:51:52', 1, 1);
INSERT INTO `bls_word` VALUES (23, '工具', '工具是属于帮区中的一个属性，是构成帮区所必不可少的元素。对“工具”词汇的使用通常是调用运行，或指定工具中的具体运行部件后得到返回结果。', '查看工具', 1, '', 4, 4, '2021-05-24 11:54:30', 1, 1);
...
INSERT INTO `bls_word` VALUES (38, '显示', '将后面跟随的词汇所表示的内容显示到页面上', '显示 所有成员', 2, '', 3, 3, '2021-05-28 17:15:44', 1, 1);
...
INSERT INTO `bls_word` VALUES (87, '角色', '权限在支撑平台的体现具体在对角色的定义上，不同角色拥有不同的权限。对用户或岗位添加角色，即对其授予了角色对应的权限。', '为张三授予读者角色。', 1, NULL, 4, 4, '2021-06-11 16:50:45', 1, 1);
INSERT INTO `bls_word` VALUES (88, '权限', '权限即是指用户在支撑平台能够活动的权力， 需要和具体的角色词汇搭配，使用该词汇通常就是对用户和岗位在平台上的权限控制，如授予权限或移除权限。', '待补充', 1, NULL, 4, 4, '2021-06-11 16:54:27', 1, 1);
INSERT INTO `bls_word` VALUES (89, 'Reader', '指读者角色，在言者角色的基础上多了可读文档的权限，在支撑平台上意指“speak ,read”的可发言和可读文档权限。在语句中使用时，通常表示要对用户和岗位在读者角色进行有关管理操作。', '待补充', 1, NULL, 4, 4, '2021-06-11 16:59:07', 1, 1);
INSERT INTO `bls_word` VALUES (90, '写者', '指写者角色，在读者角色的基础上多了写的权限，在支撑平台上意指“speak ,read ,write”的可发言、可读写文档的权限。在语句中使用时，通常表示要对用户和岗位在写者角色进行有关管理操作。', '待补充', 1, NULL, 4, 4, '2021-06-11 17:06:32', 1, 1);
INSERT INTO `bls_word` VALUES (91, '言者', '指言者角色，在支撑平台上意指“speak”的只可发言，没有读写文档、运行工具的其他权限。在语句中使用时，通常表示对用户和岗位在言者角色上进行有关管理操作。', '待补充', 1, NULL, 4, 4, '2021-06-11 17:09:29', 1, 1);
INSERT INTO `bls_word` VALUES (92, '测试词汇', '测试词汇的描述', '测试词汇的例子', 1, NULL, 2, 2, '2021-06-17 17:16:41', 0, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bls_word_node` VALUES (1, 6, 14, 1);
INSERT INTO `bls_word_node` VALUES (2, 6, 15, 1);
INSERT INTO `bls_word_node` VALUES (3, 38, 16, 1);
INSERT INTO `bls_word_node` VALUES (4, 6, 1, 1);
INSERT INTO `bls_word_node` VALUES (5, 6, 22, 0);
INSERT INTO `bls_word_node` VALUES (6, 8, 23, 0);
INSERT INTO `bls_word_node` VALUES (7, 6, 24, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bls_word_rule` VALUES (1, 6, 16, 1);
INSERT INTO `bls_word_rule` VALUES (2, 6, 17, 1);
INSERT INTO `bls_word_rule` VALUES (3, 6, 18, 1);
INSERT INTO `bls_word_rule` VALUES (4, 38, 19, 1);
INSERT INTO `bls_word_rule` VALUES (5, 23, 14, 1);
INSERT INTO `bls_word_rule` VALUES (6, 6, 25, 0);
INSERT INTO `bls_word_rule` VALUES (7, 6, 26, 0);
COMMIT;
...
CREATE TABLE `bls_word_user` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '状态：0：禁用，1：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用于记录参与创建或修改词汇的用户';
...
INSERT INTO `bls_word_user` VALUES (3, 8, 2, '2021-06-07 19:28:01', 1);
...
INSERT INTO `bls_word_user` VALUES (81, 87, 4, '2021-06-11 16:50:45', 1);
INSERT INTO `bls_word_user` VALUES (82, 88, 4, '2021-06-11 16:54:27', 1);
INSERT INTO `bls_word_user` VALUES (83, 89, 4, '2021-06-11 16:59:07', 1);
INSERT INTO `bls_word_user` VALUES (84, 90, 4, '2021-06-11 17:06:32', 1);
INSERT INTO `bls_word_user` VALUES (85, 91, 4, '2021-06-11 17:09:29', 1);
INSERT INTO `bls_word_user` VALUES (86, 92, 2, '2021-06-17 17:16:42', 1);
COMMIT;
