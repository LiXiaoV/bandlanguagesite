...
INSERT INTO `bls_dept_sentence` VALUES (5, 3, 5, 1);
...
INSERT INTO `bls_rule` VALUES (3, 'rule3', '规则3', '规则3表达式', '规则3的相关描述', '规则3的代码', 2, 2, '2021-05-31 16:52:41', 1);
COMMIT;
...
INSERT INTO `bls_rule_user` VALUES (3, 3, 2, '2021-05-31 16:52:41', 1);
COMMIT;
...
INSERT INTO `bls_sentence` VALUES (4, '句型四', '一个句型', 'ddd', 2, 2, '2021-05-24 02:57:05', 0, 1);
INSERT INTO `bls_sentence` VALUES (5, '句型五', '一个句型', 'eee', 2, 2, '2021-05-24 03:03:21', 0, 1);
...
INSERT INTO `bls_sentence` VALUES (36, '工具调用句型一', '<工具名称>和<接口名称>是指某个工具以及它所提供的功能接口的中文名称，这些名称在平台中都是唯一的。句型中如果调用的接口不需要参数，则<参数赋值短语>可以省略。', '执行 <工具名称> ，(其中，(<参数赋值短语> ，) + )? 得到 <接口名称> (、<接口名称>)*', 3, 3, '2021-05-27 09:58:33', 0, 1);
...
CREATE TABLE `bls_sentence_user` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '状态：0：禁用，1：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用于记录参与创建或修改句型的用户';
...
INSERT INTO `bls_sentence_user` VALUES (5, 5, 2, '2021-05-24 03:03:21', 1);
...
INSERT INTO `bls_sentence_user` VALUES (36, 36, 3, '2021-05-27 09:58:33', 1);
...
INSERT INTO `bls_user` VALUES (2, 'liwei', '黎威', '6b63d04f80af99ae5cde482a3559c459', '(UjrELVjqwof', '13387603239', '1011529903@qq.com', NULL, '2021-05-22 15:21:45', '2021-05-22 15:21:47', 16, 1);
INSERT INTO `bls_user` VALUES (3, 'chencongying', '陈聪颖', 'c9da383357b25f5136da98e1a9ef5113', 'GDQ9j#4nBP3)', NULL, NULL, NULL, '2021-05-24 11:26:37', '2021-05-24 11:26:42', 4, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='帮语词汇表';
...
INSERT INTO `bls_word` VALUES (7, '维度', '分析论文的一个方向', '分析维度', 1, '类型', 2, 2, '2021-05-23 23:50:18', 0, 1);
INSERT INTO `bls_word` VALUES (8, '推荐', '想别人推荐论文', '论文推荐', 2, '建议', 2, 2, '2021-05-23 23:59:45', 0, 1);
INSERT INTO `bls_word` VALUES (10, '词汇四', '一个词汇', '啊啊', 1, '词汇1', 2, 2, '2021-05-24 03:00:10', 0, 1);
...
CREATE TABLE `bls_word_user` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '状态：0：禁用，1：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用于记录参与创建或修改词汇的用户';
